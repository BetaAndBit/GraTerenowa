...
**Zadanie:** Pomóż naszym bohaterom odczytać jakim procentem Pokemon'ów typu *Dark* jest podtyp *Ice*, a następnie podaj nazwę najmnieszego podtypu w największym typie.  Wynik wpisz w formacie `liczba nazwa`, gdzie liczba to procent z dokładnością do 2 miejsc po przecinku.
